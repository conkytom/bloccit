...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  let(:sponsored_post) { my_topic.sponsored_posts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, price: rand(1..999)) }
=begin
  describe "GET #index" do
    ...
    it "assigns [sponsored_post] to @sponsored_posts" do
        get :index
